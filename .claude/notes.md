...
- [InsuranceBinder] BINDER-3001_Harborview: fixed on retry — verifier flagged: GATE1/4 insured_name: span not found verbatim in source: 'INSURED\nHarborview Logistics LLC'; GATE1/4 producing_agency: span not found verbatim in source: 'PRODUCER\nBrightline Insurance Brokers'. Re-confirmed grounding/normalization before indexing.
